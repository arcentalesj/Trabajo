...
select case session("cargo")
	...
	case "11","02","00","04"
		strSQL = "SELECT * FROM dbo.captados order by apellido,nombre"
end select
%>
<%
Dim captados
...
<html>
	<head>
		<title>Clientes Ingresados</title>
	...
	<body class="cuerpo">
		...
		<table width="100%" height ="2%"><tr></tr></table>
		<table width="1150" border="1" bgcolor="#CCCCCC" align="center">
			<tr> 
				<td width="90" class="rotulos">Cedula</td>
				<td width="200" class="rotulos">Nombre</td>
				<td width="60" class="rotulos">F. Ingreso</td>
				<td width="160" class="rotulos">Tipo de producto</td>
		...
		<table width="1150" border="1" align="center" cellspacing="0">
			...
			<tr> 
				...
				<td width="60" class="presentar" bgcolor="<%if (Repeat1__numRows mod 2)=0 then Response.Write (session("color")) end if%>">
					<%=(response.write(fechacap))%></td>
				<td width="160" class="presental" bgcolor="<%if (Repeat1__numRows mod 2)=0 then Response.Write (session("color")) end if%>">
				...
				<%select case session("cargo")
					case "11","02","00","04"%>
						...
						<%=(response.write(captados.Fields.Item("nombrevendedor").Value))%></td>
				<%end select%>
			</tr>
		...
		<table width="100%"  align="center">
			<tr>
				<td width="21%">
					<FORM NAME="volver" ACTION="menu.asp"><div align="right">
						<input type="submit" name="asigna" value="Regresar"></div>
					</FORM>
				</td>
				<td width="29%"></td>
				<td width="32%">
					<FORM NAME="reportexls" ACTION="todofechas.asp"><div align="center">
						<input type="submit" name="asigna" value="Reporte ingresados a Excel"></div>
					</FORM>
				</td>
			</tr>
		</table>
